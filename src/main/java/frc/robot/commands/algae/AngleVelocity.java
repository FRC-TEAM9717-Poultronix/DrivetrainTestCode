...
public class AngleVelocity extends Command {
  private final AlgaeSubsystem coral;
  private final DoubleSupplier  vZ;

  // Constructor
  public AngleVelocity(AlgaeSubsystem coral, DoubleSupplier vZ)
  {
    this.coral = coral;
    this.vZ = vZ;
  ...
  public void execute()
  {
    ...
    SmartDashboard.putString("algae/angle/cmd_vel", desiredVelocity.toString());

    // Make the robot move
    coral.setManualPowerAngle(desiredVelocity);
  }
